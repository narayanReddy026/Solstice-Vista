    ...
    <div className="flex flex-wrap md:flex-nowrap  items-center    ">
      <div className=" order-2 md:order-1 flex-wrap px-10 font-poppins  md:px-20 text-base md:text-6xl w-full md:w-1/2">
        ...
        <h2 className="font-medium text-center pt-6 max-w-5xl  md:text-xl text-base">
          ...
          their dream job by offering personalized services and expert guidance
          at every step.
        </h2>
      ...
      <div className="order-1 md:order-2 w-full md:w-1/2">
        <img
          src={welcome}
          alt="Company Image"
          className="rounded-3xl p-4 md:pr-4  w-full md:object-cover transition-shadow duration-300 ease-in-out hover:shadow-lg hover:shadow-black bg-white"
        />
      </div>
    </div>
  );
